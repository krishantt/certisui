...
export default function AddDocumentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate document upload and blockchain transaction
    setTimeout(() => {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-green-600">Document Uploaded Successfully!</CardTitle>
              <CardDescription>Your document has been securely stored on the blockchain</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <code className="text-sm bg-white p-2 rounded border block break-all">{documentHash}</code>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={() => router.push("/share-document")} className="flex-1">
                  Share Document
                </Button>
              </div>
            </CardContent>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Upload a document to store securely on the blockchain</CardDescription>
          </CardHeader>
          <CardContent>
